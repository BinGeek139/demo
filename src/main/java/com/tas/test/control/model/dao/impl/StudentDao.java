package com.tas.test.control.model.dao.impl;
...
import com.tas.test.control.model.dao.AbtractDemoMVCDao;
...
public class StudentDao  extends AbtractDemoMVCDao<Student>{
	...
	public Student searchById(int id) {
		...
		List<Student> list= jdbcTemplatel.query(query,new RowMapper<Student>() {
